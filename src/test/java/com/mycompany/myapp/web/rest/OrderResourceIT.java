...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().name(DEFAULT_NAME).address(DEFAULT_ADDRESS);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().name(UPDATED_NAME).address(UPDATED_ADDRESS);
        return order;
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.name(UPDATED_NAME).address(UPDATED_ADDRESS);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.name(UPDATED_NAME).address(UPDATED_ADDRESS);
